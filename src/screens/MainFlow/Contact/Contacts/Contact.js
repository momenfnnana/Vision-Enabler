                ...
                <View style={{ marginBottom: "20%" }}>
                    <View style={styles.bottomCard}>
                        ...
                        <View style={{ marginTop: 30 }}>
                            <Text style={styles.titleBottomCard}>Our teams are here to
                                <Text style={styles.help}>help</Text>
                            </Text>
                            <Text style={styles.desciption}>Whether you have a question about features, trials, pricing, need a demo, or anything else, our team is ready to answer all your questions.</Text>
                        </View>
                        <TouchableOpacity
                    ...
                    <View style={styles.bottomCard}>
                        ...
                        <View style={{ marginTop: 30 }}>
                            <Text style={styles.titleBottomCard}>Upload
                                <Text style={{ color: Color.secondary }}>CV</Text>
                            </Text>
                            <Text style={styles.desciption}>if you interested in our work upload your CV file and we will contact you later</Text>
                        </View>
                        <TouchableOpacity
                            onPress={() => navigation.navigate('UploadCV')}
                            style={styles.button}>
                            <Text style={styles.textButton}>Upload CV</Text>
                        </TouchableOpacity>
                        <Image
                            style={styles.bottomLeftImage}
                            source={require('@Assets/images/cornerQuarterCircle.png')} />
